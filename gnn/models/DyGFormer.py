...
from utils.DataLoader import EmbeddingWithProjection
...
class DyGFormer(nn.Module):
    def __init__(
        ...
        """
        DyGFormer model.
        :param node_raw_features: EmbeddingWithProjection, embedding with shape (num_nodes + 1, node_feat_dim)
        :param edge_raw_features: EmbeddingWithProjection, embedding with shape (num_edges + 1, edge_feat_dim)
        ...
        self.node_feat_dim = self.node_raw_features.embedding_dim
        self.edge_feat_dim = self.edge_raw_features.embedding_dim
