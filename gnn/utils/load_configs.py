...
def get_config_for_anomaly_detection(dataset_name: str) -> DictConfig:
    """
    ...
    # dataset_name = TRACE or CADETS
    experiment_name = f"./gnn/experiments/DARPA_{dataset_name}.yaml"
    ...
    parser.add_argument(
        ...
        type=str,
        default=experiment_name,
        #default="./gnn/experiments/DARPA_TRACE.yaml",
